...
**Plans:**
- [x] 01-01-PLAN.md — Project scaffold: pyproject.toml, package tree, .python-version, .gitignore
- [x] 01-02-PLAN.md — DB models + session + CLI entrypoint + tests (Walking Skeleton)
- [x] 01-03-PLAN.md — Pre-commit hooks, secrets baseline, validate all hooks pass
...
**Plans:**
- [x] 02-01-PLAN.md — ProductData TypedDict + BaseCrawler ABC + parse_title() + JSON fixtures + unit tests
- [x] 02-02-PLAN.md — TiendasishopCrawler + MacCenterCrawler + db/crud.py + deduplication unit tests
- [x] 02-03-PLAN.md — CLI crawl command wiring + playwright dependency + live crawl verification
...
**Plans:**
- [x] 03-01-PLAN.md — psycopg2-binary optional dep + db/crud.py (prune_old_records, count_prunable, get_db_stats) + unit tests
- [x] 03-02-PLAN.md — Implement db_clean (--days, --dry-run), db_stats (Rich table), _auto_prune hook in crawl()
...
**Plans:**
- [x] 05-01-PLAN.md — Alert module core: telegram.py with threshold logic, message formatting, env var config, httpx send; unit tests
- [x] 05-02-PLAN.md — Crawl pipeline integration: crud.py enriched return type, crawl() alert wiring, integration tests
...
**Plans:**
- [x] 06-01-PLAN.md — GitHub Actions daily cron workflow (crawl.yml)
- [x] 06-02-PLAN.md — Docker + docker-compose setup (Dockerfile, compose, .env.example)
- [x] 06-03-PLAN.md — npx autoskills installation + README documentation
...
**Plans:**
- [x] 07-01-PLAN.md — MkDocs setup, 5 doc pages, GitHub Actions deploy, build validation
...
| DB-01 | Phase 1 | Done ✅ |
| CLI-03 | Phase 1 | Done ✅ |
| CRAWL-01 | Phase 2 | Done ✅ |
| CRAWL-02 | Phase 2 | Done ✅ |
| CRAWL-03 | Phase 2 | Done ✅ |
| CRAWL-04 | Phase 2 | Done ✅ |
| CLI-01 | Phase 2 | Done ✅ |
| DB-02 | Phase 3 | Done ✅ |
| DB-03 | Phase 3 | Done ✅ |
| DB-04 | Phase 3 | Done ✅ |
...
| TUI-04 | Phase 4 | Done ✅ |
| CLI-02 | Phase 4 | Done ✅ |
| ALRT-01 | Phase 5 | Done ✅ |
| ALRT-02 | Phase 5 | Done ✅ |
| CRAWL-05 | Phase 6 | Done ✅ |
| DEV-05 | Phase 6 | Done ✅ |
| DEV-06 | Phase 6 | Done ✅ |
| DOCS-01 | Phase 7 | Done ✅ |
| DOCS-02 | Phase 7 | Done ✅ |
...
*Last updated: 2026-05-11 — All 7 phases complete, v1.0 shipped*
